        ...
        <div class="col-auto">
            <div class="list-group bg-light rounded border p-3 h-100">
                @forelse($records as $record)
                    @include('admin.calculator-settings.ceiling-height-coefficient._card')
                @empty
            ...
            <div class="sticky-top container-lg p-0 float-left" style="top: 5rem;">
                ...
                >
                    <div class="card-header bg-transparent">
                        <h4 class="m-0">Редагувати коефіцієнт на висоту стелі <span class="text-muted small"> [{{ Breadcrumbs::currentTitle() }}]</span></h4>
                    </div>
                    <div class="card-body">
                        @csrf
                        @method('put')
