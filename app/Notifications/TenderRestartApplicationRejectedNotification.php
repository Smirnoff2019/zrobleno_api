...
class TenderRestartApplicationRejectedNotification extends Notification
{
    ...
    {
        $this->tender  = $tender;
        $this->subject = "Заявка на перезапуск замовлення №{$tender->uid} відхилена!";
        $this->url     = "https://customer.zrobleno.com.ua/application";
    }
