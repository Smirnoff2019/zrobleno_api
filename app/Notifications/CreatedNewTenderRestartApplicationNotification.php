...
class CreatedNewTenderRestartApplicationNotification extends Notification
{
    ...
    {
        $this->tender  = $tender;
        $this->subject = "Ваша заявка на перезапуск замовлення прийнята. Чекайте, наш менеджер зв'яжеться з Вами найближчим часом.";
