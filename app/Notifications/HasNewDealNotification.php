...
class HasNewDealNotification extends Notification
{
    ...
    {
        $this->tender  = $tender;
        $this->subject = "Замовник пропонує укласти угоду";
        $this->url     = route('servises.contractor.tenders.show', $tender->id);;
    }
