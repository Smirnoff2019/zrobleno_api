...
class RecruitmentOfParticipantsStatus extends TenderStatus 
{
     ...
     * @var string
     */
    public const DEFAULT_NAME = 'Набір учасників';
     ...
     * @var string
     */
    public const DEFAULT_SLUG = 'recruitment_of_participants';
